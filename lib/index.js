...
module.exports = () => {
  return new Promise((resolve) => {
    lib().then((Module) => {
       ...
       *  @exports
       */
      function generateBlinded(key, blinder) {
       ...
       *  @exports
       */
      function commitment(value, generator, blinder) {
        if (
          !generator ||
       ...
       *  @arg {Array} valueBlinders List of 32-byte value blinding factors.
       *  @arg {Array} assetBlinders List of 32-byte asset blinding factors.
      ...
      function blindGeneratorBlindSum(
        ...
        if (
          !valueBlinders ||
          !Array.isArray(valueBlinders) ||
          !valueBlinders.length ||
          !valueBlinders.every((v) => v instanceof Uint8Array)
        )
          throw new TypeError(
            'valueBlinders must be a non-empty list of Uint8Array'
          );
        if (!assetBlinders || !Array.isArray(assetBlinders))
          throw new TypeError('assetBlinders must be a list of Uint8Array');
       ...
       *  @arg {Array} seed 32-byte random seed.
       */
      function proofInitialize(inputTags, outputTag, maxIterations, seed) {
        if (
          !inputTags ||
