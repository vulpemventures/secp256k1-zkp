...
module.exports = () => {
  return new Promise((resolve) => {
    lib().then((Module) => {
       ...
       *  @argument {Array} pubkey 33-byte pubkey.
       *  @argument {Array} scalar 32-byte scalar.
       *  @exports
       */
       ...
       *  @throws {Error} Decode error.
       *  @argument {Array} seed 32-byte random seed.
       *  @exports
       */
       ...
       *  @throws {Error} Decode error.
       *  @argument {Array} key 32-byte array key.
       *  @argument {Array} blinder 32-byte array blinding factor.
       *  @exports
       */
       ...
       *  @throws {Error} Decode error.
       *  @argument {string} value Uint64 value to commit to as string.
       *  @argument {Array} generator 33-byte serialized generator.
       *  @argument {Array} blinder 32-byte blinding factor.
       *  @exports
       */
       ...
       *  @throws {Error} Decode error.
       *  @argument {Array} values List of uint64 values as string.
       *  @argument {Array} assetBlinders List of 32-byte asset blinders.
       *  @argument {Array} valueBlinders List of 32-byte value blinders.
       *  @argument {number} nInputs How many of the initial array elements represent commitments that will be negated in the final sum.
       *  @exports
       */
       ...
       *  @argument {string} value Uint64 value to blind as string.
       *  @argument {Array} valueCommitment 33-byte serialized value pedersen commitmnet.
       *  @argument {Array} assetCommitment 33-byte serialized asset pedersen commitment.
       *  @argument {Array} valueBlinder 32-byte value blinding factor.
       *  @argument {Array} nonce 32-byte secret nonce used to initialize the proof (value can be reverse-engineered out of the proof if this secret is known.).
       *  @argument {string} minValue Constructs a proof where the verifer can tell the minimum value is at least the specified amount.
       *  @argument {string} base10Exp Base-10 exponent. Digits below above will be made public, but the proof will be made smaller. Allowed range is -1 to 18.
       *      (-1 is a special case that makes the value public. 0 is the most private.).
       *  @argument {string} minBits Number of bits of the value to keep private. (0 = auto/minimal, 64).
       *  @argument {Array} message Optional message.
       *  @argument {Array} extraCommitment Optional extra commitment.
       *  @exports
       */
      ...
      /**
       *  @typedef {ProofInfo}
       *  @argument {string} exp Exponent used in the proof (-1 means the value isn't private).
       *  @argument {string} mantissa Number of bits covered by the proof.
       *  @argument {string} minValue Minimum value that commit could have.
       *  @argument {string} maxValue Maximum value that commit could have.
       */
      /**
       *  @summary Returns value info from a range-proof.
       *  @return {ProofInfo} Information successfully extracted.
       *  @throws {Error} Decode failed.
       *  @argument {Array} proof Range proof for which retrieving info.
       *  @exports
       */
       ...
       *  @argument {Array} proof Range proof to verify.
       *  @argument {Array} valueCommitment 33-byte serialized value commitment.
       *  @argument {Array} assetCommitment 33-byte serialized asset commitment.
       *  @argument {Array} extraCommitment Optional extra commitment.
       */
      ...
      /**
       *  @typedef {ProofRewind}
       *  @argument {string} value Unblinded uint64 value as string.
       *  @argument {string} minValue Minimum value that commit could have.
       *  @argument {string} maxValue Maximum value that commit could have.
       *  @argument {Array} blinder 32-byte blinding factor.
       *  @argument {Array} message Unblinded optional message.
       */
      /**
       *  @summary Extracts information from a range-proof.
       *  @return {ProofRewind} Information successfully extracted.
       *  @throws {Error} Decode failed.
       *  @argument {Array} proof Range proof to rewind.
       *  @argument {Array} valueCommitment 33-byte serialized value commitment.
       *  @argument {Array} assetCommitment 33-byte serialized asset commitment.
       *  @argument {Array} nonce 32-byte secret nonce used to initialize the proof.
       *  @argument {Array} extraCommitment Optional extra commitment.
       */
       ...
       *  @throws {Error} Decode failed.
       *  @argument {Array} inputTags List of 32-byte input tags.
       *  @argument {Array} outputTag 32-byte output tag.
       *  @argument {number} maxIterations Max number of attemoots to compute the proof.
       *  @argument {Array} seed 32-byte random seed.
       */
       ...
       *  @return {Array} Serialized surjection proof.
       *  @throws {Error} Decode failed.
       *  @argument {Array} proof Initialized surjection proof.
       *  @argument {Array} inputTags List of 33-byte ephemeral input tags.
       *  @argument {Array} outputTag 33-byte ephemeral output tag.
       *  @argument {number} inputIndex Proof input index.
       *  @argument {Array} inputBlindingKey 32-byte blinding key for the input tags.
       *  @argument {Array} outputBlindingKey 32-byte blinding key for the output tag.
       */
       ...
       *  @throws {Error} Decode failed.
       *  @argument {Array} proof Surjection proof to verify.
       *  @argument {Array} inputTags List of 33-byte ephemeral input tags.
       *  @argument {Array} outputTag 33-byte ephemeral output tag.
       */
       ...
       *  @throws {Error} Decode failed.
       *  @argument {Array} key 32-byte private key to negate.
       */
       ...
       *  @throws {Error} Decode failed.
       *  @argument {Array} key 32-byte private key to tweak.
       *  @argument {Array} tweak 32-byte tweak to add to private key.
       */
       ...
       *  @throws {Error} Decode failed.
       *  @argument {Array} key 32-byte private key to tweak.
       *  @argument {Array} tweak 32-byte tweak to multiply by private key.
       */
       ...
       * @argumentument {Uint8Array} point - point to check
       ...
       *  @argumentument {Uint8Array} point - point to compress
       *  @argumentument {boolean | undefined} compressed - true if compressed, false otherwise
      ...
      function pointCompress(point, compressed) {
        ...
        if (compressed !== undefined && typeof compressed !== 'boolean') {
          throw new TypeError('compressed must be a boolean');
        }
        const outputlen =
          compressed === undefined ? point.length : compressed ? 33 : 65;
       ...
       * @param {Uint8Array} privatePoint - point to check
       * @returns {boolean} true if private, false otherwise
       */
      function isPrivate(privatePoint) {
        if (!privatePoint || !(privatePoint instanceof Uint8Array)) {
          throw new TypeError('d must be a Uint8Array');
        }

        const dPtr = charStar(privatePoint);
        const ret = Module.ccall(
          'ec_seckey_verify',
          'number',
          ['number'],
       ...
       * @param {Uint8Array} scalar - scalar to check if on the curve
       * @param {boolean | undefined} compressed - true if compressed, false otherwise
       * @returns {Uint8Array | null} point if valid, null otherwise
       */
      function pointFromScalar(scalar, compressed = true) {
        ...
        const output = malloc(outputlen);
        const dPtr = charStar(scalar);
        const ret = Module.ccall(
          'ec_point_from_scalar',
          'number',
          ['number', 'number', 'number'],
          [output, outputlen, dPtr, scalar.length]
        );
        if (ret === 1) {
          const res = new Uint8Array(
            Module.HEAPU8.subarray(output, output + outputlen)
       ...
       * @argumentument {Uint8Array} message - message to sign
       * @argumentument {Uint8Array} privateKey - private key
       * @argumentument {Uint8Array | undefined} extraEntropy - optional, added to the entropy for k generation
       ...
       * @param {Uint8Array} message - message signed
      ...
      function verifyECDSA(message, publicKey, signature, strict = false) {
        ...
        if (!publicKey || !(publicKey instanceof Uint8Array)) {
          throw new TypeError('Q must be a Uint8Array');
        }
        ...
        const ret = Module.ccall(
          ...
          'number',
          ['number', 'number', 'number', 'number', 'number'],
          [QPtr, publicKey.length, hPtr, signaturePtr, strict ? 1 : 0]
        );
        return ret === 1;
      }
       ...
       * @param {Uint8Array} message - message signed using Schnorr
       * @param {Uint8Array} publicKey - public key
       * @param {Uint8Array} signature - signature to verify
       * @returns {boolean} true if valid, false otherwise
       */
