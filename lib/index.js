...
module.exports = () => {
  return new Promise((resolve) => {
    lib().then((Module) => {
       ...
       *  @argument {boolean | undefined} compressed - true if compressed, false otherwise
       ...
       * @argument {Uint8Array} message - message to sign
       * @argument {Uint8Array} privateKey - private key
       * @argument {Uint8Array | undefined} extraEntropy - optional, added to the entropy for k generation
